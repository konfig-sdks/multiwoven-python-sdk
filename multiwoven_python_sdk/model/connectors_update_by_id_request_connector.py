...
class ConnectorsUpdateByIdRequestConnector(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def configuration() -> typing.Type['ConnectorsUpdateByIdRequestConnectorConfiguration']:
                return ConnectorsUpdateByIdRequestConnectorConfiguration
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["configuration"]) -> 'ConnectorsUpdateByIdRequestConnectorConfiguration': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "connector_type", "configuration", "connector_name", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["configuration"]) -> 'ConnectorsUpdateByIdRequestConnectorConfiguration': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "connector_type", "configuration", "connector_name", ], str]):
