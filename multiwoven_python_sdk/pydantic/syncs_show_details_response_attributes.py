...
from multiwoven_python_sdk.pydantic.syncs_show_details_response_attributes_configuration import SyncsShowDetailsResponseAttributesConfiguration

class SyncsShowDetailsResponseAttributes(BaseModel):
    ...
    configuration: typing.Optional[SyncsShowDetailsResponseAttributesConfiguration] = Field(None, alias='configuration')
