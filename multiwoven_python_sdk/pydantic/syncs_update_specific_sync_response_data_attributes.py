...
from multiwoven_python_sdk.pydantic.syncs_update_specific_sync_response_data_attributes_configuration import SyncsUpdateSpecificSyncResponseDataAttributesConfiguration

class SyncsUpdateSpecificSyncResponseDataAttributes(BaseModel):
    ...
    configuration: typing.Optional[SyncsUpdateSpecificSyncResponseDataAttributesConfiguration] = Field(None, alias='configuration')
