...
from multiwoven_python_sdk.pydantic.syncs_create_new_sync_operation_response_attributes_configuration import SyncsCreateNewSyncOperationResponseAttributesConfiguration

class SyncsCreateNewSyncOperationResponseAttributes(BaseModel):
    ...
    configuration: typing.Optional[SyncsCreateNewSyncOperationResponseAttributesConfiguration] = Field(None, alias='configuration')
